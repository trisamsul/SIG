        ...
        <div class="box">
            ...
            <table id="dt" class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                      <button type="button" title="Delete" class="btn btn-sm bg-primary" onclick="location.href='<?php echo base_url();?>admin/userRemove/<?php echo $row['user_id'];?>'"><i class="fa fa-trash"></i></button>
                    </td>
                </tr>
                <?php } ?>
                </tbody>
